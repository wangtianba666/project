...
int main()
{
    ...
    double middle_V_duty1 = 0.075;
    double middle_H_duty1 = 0.08;
    double middle_V_duty2 = 0.075;
    double middle_H_duty2 = 0.083;
    double middle_V_duty3 = 0.075;
    double middle_H_duty3 = 0.090;
...
//		}
		...
		if(flame == 3){
			middle_V_duty1 = 0.075;middle_H_duty1 = 0.074;  // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
		...
		if(flame == 4){
			middle_V_duty1 = 0.075;middle_H_duty1 = 0.074;  // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
			middle_V_duty2 = 0.075;middle_H_duty2 = 0.076; // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
			middle_V_duty3 = 0.075;middle_H_duty3 = 0.084; // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
		}
		if(flame == 5){
			middle_V_duty1 = 0.075;middle_H_duty1 = 0.072;  // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
			middle_V_duty2 = 0.075;middle_H_duty2 = 0.074; // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
			middle_V_duty3 = 0.075;middle_H_duty3 = 0.082; // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
		}
		if(flame == 6){
			middle_V_duty1 = 0.075;middle_H_duty1 = 0.069;  // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
			middle_V_duty2 = 0.075;middle_H_duty2 = 0.071; // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
			middle_V_duty3 = 0.075;middle_H_duty3 = 0.081; // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
		}
		if(flame == 7){
			middle_V_duty1 = 0.075;middle_H_duty1 = 0.067;  // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
			middle_V_duty2 = 0.075;middle_H_duty2 = 0.069; // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
			middle_V_duty3 = 0.075;middle_H_duty3 = 0.078; // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
		}
		if(flame == 8){
			middle_V_duty1 = 0.075;middle_H_duty1 = 0.066;  // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
			middle_V_duty2 = 0.075;middle_H_duty2 = 0.068; // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
			middle_V_duty3 = 0.075;middle_H_duty3 = 0.077; // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
		}
		if(flame == 9){
			middle_V_duty1 = 0.08;middle_H_duty1 = 0.0645;  // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
			middle_V_duty2 = 0.08;middle_H_duty2 = 0.0675; // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
			middle_V_duty3 = 0.08;middle_H_duty3 = 0.0765; // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
		}
		if(flame == 10){
			middle_V_duty1 = 0.085;middle_H_duty1 = 0.0658;  // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
			middle_V_duty2 = 0.085;middle_H_duty2 = 0.0675; // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
			middle_V_duty3 = 0.085;middle_H_duty3 = 0.0775; // V:0.07-0.1(81-135) ;H 0.05-0.1(45-135)
		}
